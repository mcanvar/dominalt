<template>
  <div>
      ...
      <div class="relative z-20 px-8 mx-auto xl:px-5 max-w-7xl">
        <div class="flex flex-col items-center h-full pt-16 pb-56 lg:flex-row">
          ...
          <div class="flex w-full mb-16 lg:w-1/2 lg:mb-0">
            <div
              class="relative duration-1000 delay-100 transform transition-all visible translate-y-0 opacity-100"
    ...
    >
      <div
        class="absolute top-0 left-0 z-10 w-full h-full transform -translate-x-1/2 opacity-10"
      >
        <svg
          class="w-full h-full text-white opacity-25 fill-current"
      ...
      >
        ...
        <p class="mt-4 leading-6 sm:text-center text-wave-200">
          Wave has some cool features to help you rapidly build your Software as
          a Service.<br class="hidden md:block" />
        ...
        >
          <div>
            ...
            <p class="mt-2 text-sm leading-5 sm:text-center text-wave-200">
              Fully loaded authentication, email verification, and password
              reset. Authentication in a snap!
            </p>
          </div>
          <div>
            <img
          ...
          <div>
            ...
            <p class="mt-2 text-sm leading-5 sm:text-center text-wave-200">
              Create new plans with different features and intrigue your users
          ...
          <div>
            ...
            <p class="mt-2 text-sm leading-5 sm:text-center text-wave-200">
              Grant user permissions based on roles, you can then assign a role
              to a specific plan.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p class="mt-2 text-sm leading-5 sm:text-center text-wave-200">
              Wave has been crafted using Laravel &amp; Voyager, which makes
          ...
          <div>
            ...
            <p class="mt-2 text-sm leading-5 sm:text-center text-wave-200">
              Fully configurable themes. Choose from a few starter themes to
              begin configuring to make it your own.
            </p>
          </div>
        </div>
      </div>
    ...
    <div id="testimonials">
      <div
        class="relative flex items-center justify-center pt-32 pb-12 bg-gray-100 md:pb-32 lg:pb-64 min-w-screen"
      >
        <div class="max-w-6xl px-10 pb-20 mx-auto bg-gray-100">
          <div class="flex flex-col items-center lg:flex-row">
            ...
            >
              <p
                class="mb-2 text-base font-medium tracking-tight uppercase text-wave-500"
              >
              ...
              <p
                class="pr-5 my-6 text-lg text-gray-600 md:text-center lg:text-left"
              >
              ...
              >
                <div class="flex flex-col pl-5 sm:pr-8">
                  <div class="relative sm:pl-12">
                    <svg
                      class="absolute left-0 hidden w-10 h-10 fill-current sm:block text-wave-500"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 100 125"
                    >
                      <path
                    ...
                    <p class="mt-2 text-base text-gray-600">
                      Wave allowed me to build the Software as a Service of my
                      dreams!
                    </p>
                  </div>

                  <h3
                    class="mt-3 text-base font-medium leading-5 text-gray-800 truncate sm:pl-12"
                  >
                    Jane Cooper
              ...
              >
                <div class="flex flex-col pl-5 sm:pr-10">
                  <div class="relative sm:pl-12">
                    ...
                    <p class="mt-2 text-base text-gray-600">
                      Wave saved us hundreds of development hours. Creating a
                      Software as a Service is now easier than ever with Wave.
                    </p>
                  </div>
                  <h3
                    class="mt-3 text-base font-medium leading-5 text-gray-800 truncate sm:pl-12"
              ...
              >
                <div class="flex flex-col pl-5 sm:pr-10">
                  <div class="relative sm:pl-12">
                    ...
                    <p class="mt-2 text-base text-gray-600">
                      This is the best solution available for creating your own
    ...
    <div id="pricing" class="relative">
      <div class="relative z-20 px-8 pb-8 mx-auto max-w-7xl xl:px-5">
        <div class="w-full text-left sm:text-center">
          ...
          <p
            class="w-full my-1 text-base text-left text-gray-900 opacity-75 sm:my-2 sm:text-center sm:text-xl"
          >
            ...
            >
              ...
              <div class="px-10 mt-6 pb-9">
                <p class="text-lg leading-7 text-gray-500">
                  Signup for the Basic User Plan to access all the basic
                  features.
                </p>
              </div>
                ...
                <ul class="flex flex-col space-y-2.5">
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Basic Feature Example 1 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Basic Feature Example 2 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Basic Feature Example 3 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Basic Feature Example 4 </span>
                    </span>
                  </li>
                </ul>
              </div>
          ...
          >
            ...
            >
              <div class="px-10 pt-7">
                <div class="absolute right-0 inline-block mr-6 transform">
                  <h2
                    class="relative z-20 w-full h-full px-2 py-1 text-xs font-bold leading-tight tracking-wide text-center uppercase bg-white border-2 border-wave-400 text-wave-500 rounded"
                  >
                    Premium
                  </h2>
                </div>
              ...
              <div class="px-10 mt-6 pb-9">
                <p class="text-lg leading-7 text-gray-500">
                  Signup for our premium plan to access all our Premium
                  Features.
                </p>
              </div>
                ...
                <ul class="flex flex-col space-y-2.5">
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Premium Feature Example 1 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Premium Feature Example 2 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Premium Feature Example 3 </span>
                    </span>
                  </li>
                  <li class="relative">
                    <span class="flex items-center">
                      ...
                      <span> Premium Feature Example 4 </span>
                    </span>
                  </li>
                </ul>
              </div>
        ...
        <div class="px-2 mx-auto mt-12 max-w-7xl">
          <div class="w-full p-10 text-gray-600 bg-blue-50 rounded-xl">
            <div class="flex items-center pb-4">
              <svg
                class="mr-2 w-14 h-14 text-wave-500"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              <div class="relative">
                ...
                <p class="text-sm text-blue-400">
                  Application billing is in sandbox mode, which means you can
                  test the checkout process using the following credentials:
                </p>
              </div>
            </div>
            <div class="pt-2 text-sm font-bold text-gray-500">
              Credit Card Number:
              <span class="ml-2 font-mono text-green-500"
                >4242 4242 4242 4242</span
              >
            </div>
            <div class="pt-2 text-sm font-bold text-gray-500">
              Expiration Date:
              <span class="ml-2 font-mono text-green-500">Any future date</span>
            </div>
            <div class="pt-2 text-sm font-bold text-gray-500">
              Security Code:
              <span class="ml-2 font-mono text-green-500">Any 3 digits</span>
            </div>
          </div>
        </div>

        <p class="w-full my-8 text-left text-gray-500 sm:my-10 sm:text-center">
