  ...
  <header x-data="{ mobileMenuOpen: false }" class="relative z-30 bg-white">
    <div class="px-8 mx-auto xl:px-5 max-w-7xl">
      ...
      >
            ...
            >
              ...
              <defs>
                <linearGradient
                  ...
                  y2="45.596%"
                >
                  <stop offset="0%" stop-color="#5D63FB"></stop>
                  <stop offset="100%" stop-color="#0769FF"></stop>
                </linearGradient>
                <linearGradient id="b" x1="50%" x2="50%" y1="0%" y2="100%">
                  <stop offset="0%" stop-color="#39BEFF"></stop>
                  <stop offset="100%" stop-color="#0769FF"></stop>
                </linearGradient>
                <linearGradient id="c" x1="0%" x2="99.521%" y1="50%" y2="50%">
                  <stop offset="0%" stop-color="#38BCFF"></stop>
                  <stop offset="99.931%" stop-color="#91D8FF"></stop>
                </linearGradient>
              </defs>
        ...
        <nav
          class="flex items-center justify-end flex-1 hidden w-full h-full space-x-10 md:flex"
        >
          ...
          >
            ...
            >
              <span>Product</span>
              <svg
                class="w-5 h-5 transition duration-150 ease-in-out group-hover:text-wave-600 group-focus:text-wave-600 text-gray-400"
                ...
                >
                  <div class="flex flex-col">
                    <div class="flex h-full">
                      <div
                        class="relative flex flex-col items-start justify-start hidden w-full h-full max-w-xs bg-center bg-cover lg:block"
                        style="
                          background-image: url('https://cdn.devdojo.com/images/october2020/wave-menu-bg.jpeg');
                        "
                      >
                        <div
                        ...
                        >
                          <img
                            src="https://cdn.devdojo.com/images/april2021/wave-light-logo.png"
                            class="z-20 w-auto h-10"
                          />
                          <h3
                            class="z-30 mt-1 mt-3 text-lg font-thin text-wave-200"
                          >
                            The Software as a Service Starter Kit.
                          </h3>

                          <span
                            class="relative z-20 inline-flex mt-5 rounded-md shadow-sm"
                          >
                            <a
                            ...
                            >
                              Get Wave Today
                              <span
                                class="absolute top-0 right-0 px-3 py-1 -mt-4 -mr-8 text-xs text-white rounded-full bg-wave-400"
                                >Version 2</span
                              >
                            </a>
                          </span>
                        ...
                        <div
                          class="absolute inset-0 w-full h-full opacity-75 bg-wave-600"
                        ></div>
                        <div
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <svg
                              class="relative flex-shrink-0 w-6 h-6"
                              fill="none"
                              stroke="currentColor"
                              viewBox="0 0 24 24"
                              xmlns="http://www.w3.org/2000/svg"
                          ...
                          <div class="space-y-1">
                            ...
                            <p class="text-sm leading-5 text-gray-500">
                              Full authentication system including register,
                        ...
                        >
                          ...
                          <div class="space-y-1">
                            ...
                            <p class="text-sm leading-5 text-gray-500">
                              User profiles with image uploading and profile
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="space-y-1">
                            ...
                            <p class="text-sm leading-5 text-gray-500">
                              User notification system that's easy to implement
                              in your SAAS.
                            </p>
                          </div>
                        </a>
                        ...
                        >
                          ...
                          <div class="space-y-1">
                            ...
                            <p class="text-sm leading-5 text-gray-500">
                              Add blog posts to your application to drive-in
                              organic traffic.
                            </p>
                          </div>
                        </a>
          ...
          <a
            href="https://wave.devdojo.com/blog"
            class="text-base font-medium leading-6 text-gray-500 transition duration-150 ease-in-out hover:text-wave-600 focus:outline-none focus:text-wave-600"
          >
            Blog
          </a>
          ...
          >
            ...
            >
              <div class="shadow-lg rounded-xl">
                <div
                  class="overflow-hidden border border-gray-100 shadow-md rounded-xl"
                >
                  <div class="relative z-20 grid bg-white">
                    ...
                    >
                      <svg
                        class="flex-shrink-0 w-4 h-4 mt-1 text-gray-500 duration-200 group-hover:text-gray-800 transition-color ease"
                        fill="currentColor"
                        viewBox="0 0 16 16"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                    ...
                    <a
                      href="https://devdojo.com/course/wave"
                      target="_blank"
                      class="flex items-start px-10 -m-3 space-x-3 transition duration-150 ease-in-out rounded-lg py-7 group"
                    >
                      <svg
                        class="flex-shrink-0 w-6 h-6 text-gray-500 duration-200 group-hover:text-gray-800 transition-color ease"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
          ...
          <a
            href="https://wave.devdojo.com/login"
          ...
          <span class="inline-flex rounded-md shadow-sm">
            <a
              href="https://wave.devdojo.com/register"
    ...
    <div
      ...
      x-transition:enter="duration-300 ease-out scale-100"
      x-transition:enter-start="opacity-50 scale-110"
      x-transition:enter-end="opacity-100 scale-100"
          ...
          <div class="pt-6 pb-6 space-y-6">
            ...
            <div>
              <nav class="grid row-gap-8">
                ...
                >
                  <svg
                    class="flex-shrink-0 w-6 h-6 ml-0.5 text-wave-600"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
